    ...
    <main id="user_parent_help">
        ...
        <?php else : ?>
            <?php if(isset($_GET['search'])) : ?>
                <p class="fs fw text-center" style="--fs: 18px; --fw: bold;"><?= count($newsletters) > 0 ? "Search Result of " . $_GET['search'] : "Nothing Found On: " . $_GET['search'] ?></p>
                <div>
            ...
            <?php else : ?>
                <section class="px flex flex-wrap justify-center items-stretch gap" style="--px: 100px; --gap: 5rem;">
                    <?if (count($newsletters) < 1) : ?>
                        <p class="fs fw text-center" style="--fs: 18px; --fw: bold;">There is no newsletter yet..</p>
                    <?php else: ?>
